...
if((GlobalVariable.response).contains("واحدی با این عنوان قبلا ثبت شده است"))
	CustomKeywords.'myPack.ReadWriteExcel.report'("ثبت واحد کالای تکراری","passed")
else
	CustomKeywords.'myPack.ReadWriteExcel.report'("ثبت واحد کالای تکراری","failed")