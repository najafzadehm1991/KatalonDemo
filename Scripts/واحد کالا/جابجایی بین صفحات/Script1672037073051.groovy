...
try {
	selenium.waitForCondition("selenium.isTextPresent(\"نمایش 11 تا 20\")", GlobalVariable.pageLoadWT)
}
catch(exception e){
	this.println(e)
}
GlobalVariable.response = selenium.getText("xpath=//table[@id='_dataTable']/tbody/tr[10]/td")
if(GlobalVariable.response == "20") {
...
GlobalVariable.response = selenium.getText("xpath=//table[@id='_dataTable']/tbody/tr[10]/td")
if(GlobalVariable.response == "10") {
	selenium.click("id=_dataTable_next")
	try {
		selenium.waitForCondition("selenium.isTextPresent(\"نمایش 11 تا 20\")", GlobalVariable.pageLoadWT)
	}
	catch(exception e){
	...
	GlobalVariable.response = selenium.getText("xpath=//table[@id='_dataTable']/tbody/tr[10]/td")
	if(GlobalVariable.response == "20") {
		selenium.click("id=_dataTable_previous")
		try {
		selenium.waitForCondition("selenium.isTextPresent(\"نمایش 1 تا 10\")", GlobalVariable.pageLoadWT)
	}
	catch(exception e){
...
if(GlobalVariable.successStep == "passed")
	CustomKeywords.'myPack.ReadWriteExcel.report'("جابجایی بین صفحات لیست","passed")
else
	CustomKeywords.'myPack.ReadWriteExcel.report'("جابجایی بین صفحات لیست","failed")
