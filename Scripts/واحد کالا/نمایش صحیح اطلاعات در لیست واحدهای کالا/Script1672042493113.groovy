...
GlobalVariable.response = selenium.getText("xpath=//table[@id='_dataTable']/tbody/tr/td[1]")
GlobalVariable.successStep = "undefined"
if(GlobalVariable.response=="") {
	...
	if(GlobalVariable.successStep=="passed")
		CustomKeywords.'myPack.ReadWriteExcel.report'("نمایش صحیح اطلاعات در لیست واحدهای کالا","passed")
	else
		CustomKeywords.'myPack.ReadWriteExcel.report'("نمایش صحیح اطلاعات در لیست واحدهای کالا","passed")
