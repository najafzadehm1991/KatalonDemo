...
selenium.type("xpath=//input[@type='search']", ("xxx no match found xxx").toString())
selenium.waitForCondition("selenium.isTextPresent(\"موردی یافت نشد\")", GlobalVariable.pageLoadWT)
selenium.type("xpath=//input[@type='search']", (GlobalVariable.randomNum).toString())
selenium.waitForCondition("selenium.isElementPresent(\"xpath=//table[@id='_dataTable']/tbody/tr/td[2]\")", GlobalVariable.pageLoadWT)
selenium.click("xpath=//table[@id='_dataTable']/tbody/tr/td[3]/div/a[2]/span/i")
...
if((GlobalVariable.response).contains("حذف شد"))
	CustomKeywords.'myPack.ReadWriteExcel.report'("حذف واحد کالا","passed")
else
	CustomKeywords.'myPack.ReadWriteExcel.report'("حذف واحد کالا","failed")
