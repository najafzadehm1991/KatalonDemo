...
if((GlobalVariable.response).includes("ویرایش شد"))
	CustomKeywords.'myPack.ReadWriteExcel.report'("ویرایش واحد کالا","passed")
else
	CustomKeywords.'myPack.ReadWriteExcel.report'("ویرایش واحد کالا","failed")
